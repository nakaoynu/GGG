...
IMAGE_DIR = pathlib.Path(__file__).parent / "two_step_analysis_background"
...
if __name__ == '__main__':
    ...
    all_data_raw = load_data_full_range(file_path, 'Corrected Data')
    split_data = load_and_split_data(file_path, 'Corrected Data', cutoff_freq=0.8)
